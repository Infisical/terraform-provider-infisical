...
func (p *infisicalProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		infisicalDatasource.NewProjectsListDataSource,
...
func (p *infisicalProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		infisicalResource.NewIdentityJwtAuthResource,
		...
		appConnectionResource.NewAppConnectionDigiCertResource,
		...
		infisicalResource.NewCertManagerExternalCADigiCertResource,
		...
		infisicalResource.NewCertManagerApplicationResource,
		infisicalResource.NewCertManagerApplicationProfileResource,
		infisicalResource.NewCertManagerApplicationUserResource,
		infisicalResource.NewCertManagerApplicationGroupResource,
		infisicalResource.NewCertManagerApplicationIdentityResource,
		infisicalResource.NewCertManagerUserResource,
		...
		infisicalResource.NewGatewayResource,
		infisicalResource.NewGatewayEnrollmentTokenResource,
	}
}
