...
func (client Client) CallCreateProjectIdentity(request CreateProjectIdentityRequest) (CreateProjectIdentityResponse, error) {
...
func (client Client) CallDeleteProjectIdentity(request DeleteProjectIdentityRequest) (DeleteProjectIdentityResponse, error) {
...
func (client Client) CallUpdateProjectIdentity(request UpdateProjectIdentityRequest) (UpdateProjectIdentityResponse, error) {
...
func (client Client) CallGetProjectIdentityByID(request GetProjectIdentityByIDRequest) (GetProjectIdentityByIDResponse, error) {
