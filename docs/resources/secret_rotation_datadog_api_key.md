...
page_title: "infisical_secret_rotation_datadog_api_key Resource - terraform-provider-infisical"
subcategory: "Secret Rotations"
description: |-
  Create and manage Datadog API Key Secret Rotations
---

# infisical_secret_rotation_datadog_api_key (Resource)
...
- `name` (String) The name for the generated Datadog API keys.
...
- `api_key` (String) The name of the secret that the rotated Datadog API key will be mapped to.
- `api_key_id` (String) The name of the secret that the Datadog API key ID will be mapped to.
