...
page_title: "infisical_certificate_sync_aws_certificate_manager Resource - terraform-provider-infisical"
subcategory: "Certificate Syncs"
description: |-
  Create and manage AWS Certificate Manager certificate syncs
---

# infisical_certificate_sync_aws_certificate_manager (Resource)
...
- `destination_config` (Attributes) The destination configuration for the certificate sync. (see [below for nested schema](#nestedatt--destination_config))
...
- `id` (String) The ID of the AWS Certificate Manager certificate sync
...
```shell
# This will import the AWS Certificate Manager certificate sync by its ID
terraform import infisical_certificate_sync_aws_certificate_manager.example <certificate_sync_id>
```
